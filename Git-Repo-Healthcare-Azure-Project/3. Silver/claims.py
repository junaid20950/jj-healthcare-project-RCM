...
claims_df=spark.read.csv("dbfs:/mnt/landing/claims/*.csv",header=True)
...
claims_df.write.format("parquet").mode("overwrite").save("dbfs:/mnt/bronze/claims/")
...
# MAGIC %sql
# MAGIC create schema if not exists jj_hc_adb_ws.silver
